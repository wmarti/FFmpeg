...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=aarch64 --target-os=darwin --disable-everything --disable-programs --disable-all --disable-autodetect --disable-iconv --disable-zlib --enable-avcodec --enable-avutil --enable-avformat --enable-decoder=xmaframes --enable-demuxer=wav"
