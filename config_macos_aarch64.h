...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=aarch64 --target-os=darwin --disable-everything --disable-programs --disable-all --disable-autodetect --enable-avcodec --enable-avutil --enable-decoder=xmaframes"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Apple clang version 14.0.0"
