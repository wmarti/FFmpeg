...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=x86_64 --target-os=darwin --disable-everything --disable-programs --disable-all --disable-autodetect --disable-x86asm --disable-iconv --disable-zlib --enable-avcodec --enable-avutil --enable-avformat --enable-decoder=xmaframes --enable-demuxer=wav --cc=clang --extra-cflags='-arch x86_64' --extra-ldflags='-arch x86_64'"
